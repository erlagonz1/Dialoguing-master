class Talking extends Phaser.Scene {
    ...
    init() {
        ...
        this.DBOX_FONT = 'harukaze_white'	    // dialog box font key
    ...
    create() {
        ...
        this.itachi = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'itachi').setOrigin(0.2,0.75).setScale(0.4).setDepth(-1)
